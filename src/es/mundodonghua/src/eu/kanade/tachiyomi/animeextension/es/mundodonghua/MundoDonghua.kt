...
class MundoDonghua : ConfigurableAnimeSource, ParsedAnimeHttpSource() {
    ...
    override fun animeDetailsParse(document: Document): SAnime {
        ...
        anime.thumbnail_url  =  baseUrl + document.selectFirst("div.col-md-4.col-xs-12.mb-10 div.row.sm-row > div.side-banner > div.banner-side-serie")!!.attr("style").substringAfter("background-image: url(").substringBefore(")")
...
override fun searchAnimeRequest(page: Int, query: String, filters: AnimeFilterList): Request {
    ...
    String>>
        ...
        private fun parseStatus(): Int = when {
